...
public class TeadConfiguredFeatures {
    ...
    public static final RegistryKey<ConfiguredFeature<?, ?>> DEEPSLATE_RUBY_ORE_KEY =
            registerKey("deepslate_ruby_ore");
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> context) {
        ...
        List<OreFeatureConfig.Target> overworldDeepslateRubyOres = List.of(OreFeatureConfig.createTarget(
