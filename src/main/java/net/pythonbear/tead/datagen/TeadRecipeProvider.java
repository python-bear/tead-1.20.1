...
public class TeadRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(Consumer<RecipeJsonProvider> exporter) {
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.TOOLS, TeadItems.DIAMOND_STALWART_HELMET, 1)
                ...
                .offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.TOOLS, TeadItems.NETHERITE_STALWART_HELMET, 1)
                .pattern(" # ")
                .pattern("#%#")
                .pattern(" # ")
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.TOOLS, TeadItems.DIAMOND_STALWART_CHESTPLATE, 1)
                ...
                .offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.TOOLS, TeadItems.NETHERITE_STALWART_CHESTPLATE, 1)
                .pattern("$$$")
                .pattern("$#$")
                .pattern("%$%")
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.TOOLS, TeadItems.DIAMOND_PLATE_HELMET, 1)
                ...
                .criterion(hasItem(Items.DIAMOND_HELMET), conditionsFromItem(Items.DIAMOND_HELMET))
                .offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.TOOLS, TeadItems.NETHERITE_PLATE_HELMET, 1)
                .pattern("#%#")
                .pattern("###")
                .input('#', Items.NETHERITE_INGOT)
                .input('%', Items.LEATHER)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.TOOLS, TeadItems.DIAMOND_PLATE_CHESTPLATE, 1)
                ...
                .criterion(hasItem(Items.DIAMOND_CHESTPLATE), conditionsFromItem(Items.DIAMOND_CHESTPLATE))
                .offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.TOOLS, TeadItems.NETHERITE_PLATE_CHESTPLATE, 1)
                .pattern("$$$")
                .pattern("%#%")
                .pattern("$ $")
                .input('#', Items.NETHERITE_CHESTPLATE)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.TOOLS, TeadItems.DIAMOND_PLATE_BOOTS, 1)
                ...
                .offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.TOOLS, TeadItems.NETHERITE_PLATE_BOOTS, 1)
                .pattern(" $ ")
                .pattern("%#%")
                .pattern(" $ ")
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.TOOLS, TeadItems.DIAMOND_HIGHLAND_HELMET, 1)
                ...
                .criterion(hasItem(Items.DIAMOND_HELMET), conditionsFromItem(Items.DIAMOND_HELMET))
                .offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.TOOLS, TeadItems.NETHERITE_HIGHLAND_HELMET, 1)
                .pattern("#$#")
                .pattern(" % ")
                .input('#', Items.NETHERITE_INGOT)
                .input('$', Items.NETHERITE_HELMET)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.TOOLS, TeadItems.DIAMOND_HIGHLAND_CHESTPLATE, 1)
                ...
                .criterion(hasItem(Items.DIAMOND), conditionsFromItem(Items.DIAMOND))
                .offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.TOOLS, TeadItems.NETHERITE_HIGHLAND_CHESTPLATE, 1)
                .pattern("# #")
                .pattern("#%#")
                .pattern("%#%")
                .input('#', Items.NETHERITE_INGOT)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.TOOLS, TeadItems.DIAMOND_ROYAL_HELMET, 1)
                ...
                .criterion(hasItem(Items.DIAMOND), conditionsFromItem(Items.DIAMOND))
                .offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.TOOLS, TeadItems.NETHERITE_ROYAL_HELMET, 1)
                .pattern("# #")
                .pattern("###")
                .input('#', Items.NETHERITE_INGOT)
                .criterion(hasItem(Items.NETHERITE_INGOT), conditionsFromItem(Items.NETHERITE_INGOT))
