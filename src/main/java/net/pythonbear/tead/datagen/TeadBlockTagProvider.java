...
public class TeadBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup arg) {
        getOrCreateTagBuilder(BlockTags.PICKAXE_MINEABLE)
                ...
                .add(TeadBlocks.LEAD_CUT_SLAB)
                .add(TeadBlocks.LEAD_CUT_STAIRS)
                .add(TeadBlocks.LEAD_TILED_BLOCK)
                .add(TeadBlocks.ROSE_GOLD_BLOCK)
                .add(TeadBlocks.WHITE_GOLD_NETHER_ORE)
                .add(TeadBlocks.WHITE_GOLD_BLOCK)
                .add(TeadBlocks.BRASS_BLOCK)
                .add(TeadBlocks.BRASS_CUT_BLOCK)
                .add(TeadBlocks.BRASS_CUT_SLAB)
                .add(TeadBlocks.BRASS_CUT_STAIRS)
                .add(TeadBlocks.BRONZE_BLOCK)
                .add(TeadBlocks.BRONZE_CUT_BLOCK)
                .add(TeadBlocks.BRONZE_CUT_SLAB)
                .add(TeadBlocks.BRONZE_CUT_STAIRS)
                .add(TeadBlocks.STEEL_BLOCK)
                .add(TeadBlocks.RUBY_ORE)
                .add(TeadBlocks.DEEPSLATE_RUBY_ORE)
                .add(TeadBlocks.RUBY_BLOCK)

                .add(TeadBlocks.GOLD_CHAIN)
                .add(TeadBlocks.LEAD_CHAIN)
                .add(TeadBlocks.ROSE_GOLD_CHAIN)
                .add(TeadBlocks.WHITE_GOLD_CHAIN)
                .add(TeadBlocks.BRONZE_CHAIN)
                .add(TeadBlocks.BRASS_CHAIN)
