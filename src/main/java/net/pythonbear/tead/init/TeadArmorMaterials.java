...
public enum TeadArmorMaterials implements ArmorMaterial {
    ...
    IRON_STALWART("iron_stalwart", 16, new int[] {2, 6, 5, 2}, 9,
            SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0, 0.5f,
            () -> Ingredient.ofItems(Items.IRON_INGOT)),
    DIAMOND_STALWART("diamond_stalwart", 34, new int[] {3, 8, 6, 3}, 10,
            SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 2, 0.6f,
            () -> Ingredient.ofItems(Items.DIAMOND)),
    NETHERITE_STALWART("netherite_stalwart", 38, new int[] {3, 8, 6, 3}, 15,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3, 0.7f,
            () -> Ingredient.ofItems(Items.NETHERITE_INGOT)),
    GOLD_ROYAL("gold_royal", 6, new int[] {2, 5, 3, 1}, 30,
            SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 0, 0,
            () -> Ingredient.ofItems(Items.GOLD_INGOT)),
    IRON_ROYAL("iron_royal", 12, new int[] {2, 6, 5, 2}, 14,
            SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0, 0,
            () -> Ingredient.ofItems(Items.IRON_INGOT)),
    DIAMOND_ROYAL("diamond_royal", 31, new int[] {3, 8, 6, 3}, 15,
            SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 2, 0,
            () -> Ingredient.ofItems(Items.DIAMOND)),
    NETHERITE_ROYAL("netherite_royal", 35, new int[] {3, 8, 6, 3}, 20,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3, 0.1f,
            () -> Ingredient.ofItems(Items.NETHERITE_INGOT)),
    GOLD_HIGHLAND("gold_highland", 7, new int[] {1, 5, 3, 2}, 26,
    ...
    NETHERITE_HIGHLAND("netherite_highland", 37, new int[] {3, 8, 6, 3}, 16,
            ...
            () -> Ingredient.ofItems(Items.NETHERITE_INGOT)),
    GOLD_PLATE("gold_plate", 10, new int[] {2, 5, 3, 1}, 25,
            SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 1, 0.1f,
            () -> Ingredient.ofItems(Items.GOLD_INGOT)),
    IRON_PLATE("iron_plate", 18, new int[] {2, 6, 5, 2}, 9,
            SoundEvents.ITEM_ARMOR_EQUIP_IRON, 1, 0.1f,
            () -> Ingredient.ofItems(Items.IRON_INGOT)),
    DIAMOND_PLATE("diamond_plate", 36, new int[] {3, 8, 6, 3}, 10,
            SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 3, 0.1f,
            () -> Ingredient.ofItems(Items.DIAMOND)),
    NETHERITE_PLATE("netherite_plate", 40, new int[] {3, 8, 6, 3}, 15,
