...
public class DoubleHighlandAxeItem extends AxeItem {
    private final float attackDamage;
    public final float knockbackMagnitude;
    public final float knockbackRadius;
    private final Multimap<EntityAttribute, EntityAttributeModifier> attributeModifiers;

    public DoubleHighlandAxeItem(ToolMaterial toolMaterial, Settings settings) {
        super(toolMaterial, 8 - 1, 0.7f - 4, settings.maxDamage(toolMaterial.getDurability() + 16));
        this.knockbackMagnitude = 0.2f;
        this.knockbackRadius = 0.6f;
        this.attackDamage = toolMaterial.getAttackDamage() + 8 - 1;
        ...
        builder.put(EntityAttributes.GENERIC_ATTACK_SPEED, new EntityAttributeModifier(ATTACK_SPEED_MODIFIER_ID,
                "Weapon modifier", 0.7f - 4, EntityAttributeModifier.Operation.ADDITION));
