...
public class RubyMountaineerPickItem extends MountaineerPickItem implements TransmutableTool {
    public RubyMountaineerPickItem(ToolMaterial toolMaterial, Settings settings) {
