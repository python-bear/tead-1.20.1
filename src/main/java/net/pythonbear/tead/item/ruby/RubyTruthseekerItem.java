...
public class RubyTruthseekerItem extends TruthseekerItem implements TransmutableTool {
    public RubyTruthseekerItem(ToolMaterial toolMaterial, Settings settings) {
