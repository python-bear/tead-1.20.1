...
import net.pythonbear.tead.item.tool.DoubleAxeItem;
...
public class RubyDoubleAxeItem extends DoubleAxeItem implements TransmutableTool {
    public RubyDoubleAxeItem(ToolMaterial toolMaterial, Settings settings) {
