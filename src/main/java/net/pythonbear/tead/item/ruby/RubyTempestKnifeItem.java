...
public class RubyTempestKnifeItem extends TempestKnifeItem implements TransmutableTool {
    public RubyTempestKnifeItem(ToolMaterial toolMaterial, Settings settings) {
