...
public class RubyCrescentDaggerItem extends CrescentDaggerItem implements TransmutableTool {
    public RubyCrescentDaggerItem(ToolMaterial toolMaterial, Settings settings) {
