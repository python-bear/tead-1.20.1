...
public class RubyGreatswordItem extends GreatswordItem implements TransmutableTool {
    public RubyGreatswordItem(ToolMaterial toolMaterial, Settings settings) {
