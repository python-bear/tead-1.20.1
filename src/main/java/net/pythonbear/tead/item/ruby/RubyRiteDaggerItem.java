...
public class RubyRiteDaggerItem extends RiteDaggerItem implements TransmutableTool {
    public RubyRiteDaggerItem(ToolMaterial toolMaterial, Settings settings) {
