...
public class RubyHollowDaggerItem extends HollowDaggerItem implements TransmutableTool {
    public RubyHollowDaggerItem(ToolMaterial toolMaterial, Settings settings) {
