...
public class RubyDoubleHighlandAxeItem extends DoubleHighlandAxeItem implements TransmutableTool {
    public RubyDoubleHighlandAxeItem(ToolMaterial toolMaterial, Settings settings) {
