...
public class RubyBroadswordItem extends BroadswordItem implements TransmutableTool {
    public RubyBroadswordItem(ToolMaterial toolMaterial, Settings settings) {
