...
public class PowerBowItem extends BowItem implements Vanishable {
    ...
    public void onStoppedUsing(ItemStack stack, World world, LivingEntity user, int remainingUseTicks) {
        ...
        if (!world.isClient) {
            ...
            persistentProjectileEntity.setVelocity(playerEntity, playerEntity.getPitch(), playerEntity.getYaw(),
                    0.0f, f * 4.2f, 0.9f);
            persistentProjectileEntity.setDamage(persistentProjectileEntity.getDamage() + this.attackDamage);
            if (f == 1.0f) {
